				...
				if(isset($data_compose['Hash'])){
					...
					if ($curl->error) {
						...
						if(mysqli_query($db, $qry)){
							...
							// header('Location: '.$URL);
               				echo json_encode(array("success"=>true,"message"=>"Successfully Data Added",'HASH'=>$data_compose['Hash'],'file'=>$data_compose['Name'], 'address'=>$address['address'], 'fees'=>$value_fees));
						}
						else{
