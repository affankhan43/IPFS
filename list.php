					...
					<div class="col-lg-7">
						...
						<div class="jumbotron text-center">
							...
							<div class="PayBear__Icons">
								<div role="button" tabindex="0" class="PayBear__Item" onclick="createpay('eth','<?php echo $all_data['ipfs_hash']; ?>','<?php echo $all_data['bitcoin_address']; ?>')">
								...
								<div role="button" tabindex="0" class="PayBear__Item" onclick="createpay('btc','<?php echo $all_data['ipfs_hash']; ?>','<?php echo $all_data['bitcoin_address']; ?>')">
									<div class="PayBear__Item__icon">
								...
								<div role="button" tabindex="0" class="PayBear__Item" onclick="createpay('ltc','<?php echo $all_data['ipfs_hash']; ?>','<?php echo $all_data['bitcoin_address']; ?>')">
									<div class="PayBear__Item__icon">
								...
								<div role="button" tabindex="0" class="PayBear__Item" onclick="createpay('bch','<?php echo $all_data['ipfs_hash']; ?>','<?php echo $all_data['bitcoin_address']; ?>')">
									<div class="PayBear__Item__icon">
								...
								<div role="button" tabindex="0" class="PayBear__Item" onclick="createpay('btg','<?php echo $all_data['ipfs_hash']; ?>','<?php echo $all_data['bitcoin_address']; ?>')">
									<div class="PayBear__Item__icon">
								...
								<div role="button" tabindex="0" class="PayBear__Item" onclick="createpay('dash','<?php echo $all_data['ipfs_hash']; ?>','<?php echo $all_data['bitcoin_address']; ?>')">
									<div class="PayBear__Item__icon">
