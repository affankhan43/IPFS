					...
					<div class="col-lg-7">
						...
						<div class="jumbotron text-center">
							...
							<div class="PayBear__Icons">
								<div role="button" tabindex="0" class="PayBear__Item" onclick="createpay('eth')">
								...
								<div role="button" tabindex="0" class="PayBear__Item" onclick="create_pay('btc')">
									<div class="PayBear__Item__icon">
								...
								<div role="button" tabindex="0" class="PayBear__Item" onclick="create_pay('ltc')">
									<div class="PayBear__Item__icon">
								...
								<div role="button" tabindex="0" class="PayBear__Item" onclick="create_pay('bch')">
									<div class="PayBear__Item__icon">
								...
								<div role="button" tabindex="0" class="PayBear__Item" onclick="create_pay('btg')">
									<div class="PayBear__Item__icon">
								...
								<div role="button" tabindex="0" class="PayBear__Item" onclick="create_pay('dash')">
									<div class="PayBear__Item__icon">
