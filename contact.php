	...
	<div class="container-fluid" id="wrapper">
		<div class="row">
			...
			<ul class="nav nav-pills flex-column sidebar-nav">
					...
					<li class="nav-item"><a class="nav-link active" href="contact.php"><em class="far fa-envelope"></em> Contact</a></li>
			...
			<main class="col-xs-12 col-sm-8 col-lg-9 col-xl-10 pt-3 pl-4 ml-auto">
				...
				<br>
				<p>
				Please help us improve the site by providing feedback!<br>
Having problems with our service? We can help!<br>
<br>
For questions, email contact@saveonblock.com
